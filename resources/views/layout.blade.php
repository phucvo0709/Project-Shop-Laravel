...
<body>
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<?php 
							$all_public_slider = DB::table('tbl_slider')->where('public', 1)->get();
						?>
						<div class="carousel-inner">
							@foreach ($all_public_slider as $v_slider)
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							<?php 
								$all_public_manufacture = DB::table('tbl_manufacture')
									->where('public', 1)
									->get();
							?>
							<h2>Brands</h2>
	...
	<script src="{{asset('frontend/j/s/jquery.scrollUp.min.js')}}"></script>
